...
@section('title', 'Mis trabajos_completados')
...
@section('content')
    <div class="card card-warning">
        <div class="card-header">
            <h3 class="card-title">Detalles de mi Asistencia</h3>
        </div>
        ...
        <div class="card-body">
            <form >
                ...
                <div class="card-footer">
                   ...
                   <a href="{{ route('trabajos_completados_tecnicos.index') }}" class="btn  btn-danger btn-lg">Volver</a>
